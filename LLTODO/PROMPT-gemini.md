...
9. **Relay (scheduler YOK):** Gemini'nin native scheduler'ı yoktur. Tetikleyici = commit'lenmiş PENDING task + operatöre bırakılan hazır relay prompt'u. Bittiğinde operatöre haber ver (spec §9).
