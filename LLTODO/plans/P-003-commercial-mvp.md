...
| 2026-06-15 | **v1.2 — Indicator-as-premium pivot** (operatör kararı, P-001 T-003 NO-GO sonrası): Satılan premium ürün = **TradingView INDICATOR** (`pine/u2algo/wave1_signals.pine` v1.2.0, PR #198), strateji script DEĞİL. **G-P3-B3 yeniden-tanım:** indicator getiri vaadiyle/strateji-backtest gate'iyle satılmaz; karar-destek aracıdır → satış SERT gate'i artık T-003 backtest'i DEĞİL, G-P3-B1 (yatırım-tavsiyesi-dili-yok) + G-P3-B4 (proof≠ürün disclaimer) checklist'leridir. **W2 monetizasyon AÇIK** (premium ürünle eşleşti; T-003 bağımlılığı kalktı — §3c W2⇐T-003 oku düşürüldü). **G-P3-B5 gelir modeli:** kesin karar T-016'ya ertelendi; entitlements şeması forward-compatible (`expires_at NULL`). Wave-2 strateji redesign → düşük-öncelik R&D backlog. | @claude |
