...
9. **Self-schedule (OTOMATİK, zorunlu):** İşi ilerlettikten sonra LLTODO recheck'ini native scheduler ile planla (`ScheduleWakeup` / cron / `/schedule`). Claude için opsiyonel değildir (spec §9).
