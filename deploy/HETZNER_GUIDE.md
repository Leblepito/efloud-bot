...
curl -fsSL https://raw.githubusercontent.com/Leblepito/efloud-bot/master/deploy/setup-server.sh -o setup.sh
bash setup.sh
...
git clone https://github.com/Leblepito/efloud-bot.git -b master /opt/efloud-bot
