...
from data.timeframes import tf_to_minutes  # re-export: keep `from data.fetcher import tf_to_minutes` working
...
class OHLCVFetcher:
    ...
    # TODO(Phase 3): Add unit test for fetch_funding_rates once engine consumes funding data.
