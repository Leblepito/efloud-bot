...
from backtest.metrics import aggregate_metrics, apply_funding_costs, serialize_trade
...
def run_backtest(
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="bt_") as state_dir:
        ...
        # S2b: apply funding from sim-time holding duration. Rate resolution:
        # param → config["backtest"]["funding_pct_per_8h"] → 0.0 (off, backward-
        # compat). Funding is an average symmetric drag (see apply_funding_costs);
